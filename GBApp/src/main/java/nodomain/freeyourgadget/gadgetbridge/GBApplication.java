...
public class GBApplication extends Application {
    ...
    @Modified(arg = "added")
    private static Class<? extends Activity> mainAct= ControlCenterv2.class;
    ...
    @Modified(arg = "added")
    protected static void setMainAct(Class<? extends Activity> activity){
        mainAct= activity;
    }

    public static void toMainActivity(Activity currentActivity, boolean clearTopActivity){
        Intent i= new Intent(currentActivity, mainAct);
        if(clearTopActivity)
