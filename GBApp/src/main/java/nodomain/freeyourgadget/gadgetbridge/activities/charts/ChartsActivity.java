...
import nodomain.freeyourgadget.gadgetbridge.devices.ExtendedDeviceCoordinator;
...
public class ChartsActivity extends AbstractGBFragmentActivity implements ChartsHost {
    ...
    protected AbstractFragmentPagerAdapter createFragmentPagerAdapter(FragmentManager fragmentManager) {
        try{
            AbstractFragmentPagerAdapter adp= ((ExtendedDeviceCoordinator) DeviceHelper.getInstance().getCoordinator(mGBDevice))
                    .getChartFragmentAdapter(fragmentManager, mGBDevice);
            assert adp != null;
            return adp;
