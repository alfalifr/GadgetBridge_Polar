...
public class DeviceManager {
                ...
                case GBDevice.ACTION_DEVICE_CHANGED:
                    ...
                    if (dev.getAddress() != null) {
                        ...
                        if (index >= 0) {
                            ...
                            deviceList.add(dev);
                            _LogFunKt.loge(this, "DeviceManager mReceiver case GBDevice.ACTION_DEVICE_CHANGED: added dev= " +dev);
                        }
    ...
    private void refreshPairedDevices() {
        ...
        _LogFunKt.loge(this, "refreshPairedDevices() availableDevices.size= " +availableDevices.size());
