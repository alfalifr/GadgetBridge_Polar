...
import nodomain.freeyourgadget.gadgetbridge.devices.polar.PolarCoordinator;
...
public class DeviceHelper {
    ...
    public Set<GBDevice> getAvailableDevices(Context context) {
        ...
        _LogFunKt.loge(this, "getAvailableDevices() availableDevices.size= " +availableDevices.size());
    ...
    private List<DeviceCoordinator> createCoordinators() {
        ...
        //Modded
        result.add(new PolarCoordinator());
