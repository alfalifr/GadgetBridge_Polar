...
@Modified(arg = "inherits AppCompatActivity -> Fragment, name HRActivity -> HRFrag")
public class HRFrag extends Frag /*AppCompatActivity*/ implements PlotterListener {
    ...
    @Modified(arg = "private -> protected")
    protected TimePlotter plotter;

    @Modified(arg = "default -> protected")
    protected TextView textViewHR, textViewFW;

    @Modified(arg = "private -> protected")
    protected String TAG = "Polar_HRActivity";
